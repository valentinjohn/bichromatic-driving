...
axs[0,0].annotate("", xy=(fq1, 0.75), xytext=(fq1_, 0.75), arrowprops=dict(arrowSTYLE="<->"))
...
axs[1,0].set_xlabel(r'$f_{p4}$ [GHz]')
...
axs[0,1].annotate("", xy=(fq2, 0.75), xytext=(fq2_, 0.75), arrowprops=dict(arrowSTYLE="<->"))
...
axs[1,1].set_xlabel(r'$f_{p2}$ [GHz]')
