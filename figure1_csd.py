...
#******************************************************************************
# detuning axis plot
plt.plot([50, -50], [-50, 50], ls='-', c='black', zorder=1, lw=1, label=r'$ϵ_{12}$')
